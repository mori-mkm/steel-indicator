"""Orquestrador do relatorio PDF do IPIA (3 paginas).
...
def gerar_relatorio_ipia(caminho_pdf: str, ano_ini: int = 2020, ano_fim: int = 2026,
    ...
    """Gera o relatorio PDF de 3 paginas (capa, decomposicao de custo,
    dashboard) e devolve o numero de meses na serie do IPIA usada.
    ...
    with PdfPages(caminho_pdf) as pdf:
        ...
        pages.pagina_dashboard(fig3, df_ipia, df_custo, df_origem, data_geracao, pagina_num=3)
        pdf.savefig(fig3)
        plt.close(fig3)
